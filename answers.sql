...
Write a query that shows all the distinct regions that a salesperson
can belong to, sorted alphabetically.


-----


SELECT DISTINCT region FROM salespeople ORDER BY region;
...
FROM order_items JOIN melons ON (melons.id = order_items.melon_id) 
WHERE order_id = 2725;
